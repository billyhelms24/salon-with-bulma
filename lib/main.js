...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var showAddColorModalButton = document.getElementById("showAddColorModal").addEventListener("click", function () {
        document.getElementById("addColorModal").classList.add("is-active");
    });
    var hideAddColorModalButton = document.getElementById("hideAddColorModal").addEventListener("click", function () {
        document.getElementById("addColorModal").classList.remove("is-active");
    });
